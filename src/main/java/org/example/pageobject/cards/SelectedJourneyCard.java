...
public class SelectedJourneyCard extends BaseBlock {
    ...
    public String getDepartmentCityInfo(){
        return routeInfo.getText().split(" to ")[0];
    }

    public String getDestinationCityInfo(){
        return routeInfo.getText().split(" to ")[1];
    }
    ...
    public String getDepartureAirport(){
        expandCardInfo();
        return this.getSelf().getWrappedElement().findElement(By.xpath(".//div[@data-stid=\"departure-coordinate-0\"]//p[@class=\"uitk-subheading uitk-spacing uitk-spacing-margin-blockstart-half uitk-spacing-padding-inlinestart-six\"]"))
                .getText();
    }

    public String getArrivalAirport(){
        expandCardInfo();
        return this.getSelf().getWrappedElement().findElement(By.xpath(".//div[@data-stid=\"arrival-coordinate-0\"]//p[@class=\"uitk-subheading uitk-spacing uitk-spacing-margin-blockstart-half uitk-spacing-padding-inlinestart-six\"]"))
                .getText();
    }
